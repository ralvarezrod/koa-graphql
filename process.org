...
*** Write prettier.config.js file
    ...
    #+END_SRC
*** Testing ctrl + shift + i => formmating ok!
*** Install and config eslint
    * Guia en esta URL: https://platzi.com/tutoriales/1339-fundamentos-javascript/2181-como-usar-eslint-y-prettier-para-mejorar-tu-codigo-javascript/
**** Get packages
     #+BEGIN_SRC sh
...
**** Base config
     ...
     #+END_SRC
     * We'll have to answer some questions to configure eslint
       * How would you like to use ESLint?
         * > To chheck syntax, find problems and enforce code style
         * I'm forcing myself to code things right
       * What type of modules does your project use?
         * JavaScript modules (import/export)
           * Since i'm using es6...
       * Wich framework does your project use?
         * None of these
           * Since this is just an api... no need for a frontend framework
...
**** Then it will ask to install coding style plugins, we say yes
**** Pull prettier packages
     #+BEGIN_SRC sh
...
**** tweak package.json
     #+BEGIN_SRC javascript
       // package.json
       "scripts" {
         "lint": "eslint ./", // solo para revizar nuestros archivos
           "lint:fix": "eslint ./ --fix" // corrigiendo errores
       },
     #+END_SRC
**** restart vscode and we're ready
